...
const Footernonmobile = () => {
  const useStyles = makeStyles((theme) => ({
    ...
    const [catheight, setcatheight] = useState('140px');
    const activecategory =()=>{
        setcategorytogle(!categorytogle)
    }
    ...
    return (
      <div className={classes.root}>
        <div className={classes.cat} onClick={clickme}>
          ELECTRONICS
          {(categorytogle && (<MinimizeIcon className={classes.add_icon}/>)) ||   <AddIcon className={classes.add_icon} />}
         
        </div>

        {(categorytogle && (
          <div className={classes.sub_cat}>
            <a className={classes.sub_sub_cat} >Mobiles</a>  
            <a className={classes.sub_sub_cat} >Mobiles</a>  
            <a className={classes.sub_sub_cat} >Mobiles</a>  
            <a className={classes.sub_sub_cat} >Mobiles</a>  
            <a className={classes.sub_sub_cat} >Mobiles</a>  
     ...
     <div className={classes.apps}>
       ...
       <div className={classes.apps_title}><h1>SHOP ON THE GO</h1></div>
       <div className={classes.apps_title}>
       <img src="https://z.nooncdn.com/s/app/com/common/images/logos/google-play.svg" alt="Google Play" class="gz61sw-10 bZUCoj"/> 
...
export default Footernonmobile
